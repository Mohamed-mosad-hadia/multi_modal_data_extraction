...
def main():
    parser = argparse.ArgumentParser(
        description="Transform and annotate extracted PDF data."
    )
    parser.add_argument(
        "--input",
        type=str,
        default="outputs/extracted_text/all_extracted_data.json",
    ...
    logger.info(f"Starting transformation for file: {input_path}")
